...
<details>
  ...
  <p align="center">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/9-sickqyI6Q" title="RTL for VS Code Agents - Preview" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </p>
</details>
...
The installer scripts automatically handle Claude Code setup. When you run `install.ps1` or `install.sh`, you'll be prompted whether to inject RTL support into Claude Code. If you choose "yes", the scripts will:
...
- If the script stops working after an update, the CSS selectors may have changed - please report this by opening an [issue on GitHub](https://github.com/YOUR_USERNAME/rtl-for-vs-code-agents/issues) or discussion
